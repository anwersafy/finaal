...
import 'package:flutterexcel/Excel%20helper/Gsheet_helper.dart';
...
getCLODataColumnFromExcel()async{
  for (var i = 0; i < 12; i++) {
    if(i==0){
      CLO1_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO1_Achievment_Report_$i', CLO1_Achievment_Report_controller);
    }
    if(i==1){
      CLO2_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO2_Achievment_Report_$i', CLO2_Achievment_Report_controller);
    }
    if(i==2){
      CLO3_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO3_Achievment_Report_$i', CLO3_Achievment_Report_controller);
    }
    if(i==3){
      CLO4_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO4_Achievment_Report_$i', CLO4_Achievment_Report_controller);
    }
    if(i==4){
      CLO5_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO5_Achievment_Report_$i', CLO5_Achievment_Report_controller);
    }
    if(i==5){
      CLO6_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO6_Achievment_Report_$i', CLO6_Achievment_Report_controller);
    }
    if(i==6){
      CLO7_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO7_Achievment_Report_$i', CLO7_Achievment_Report_controller);
    }
    if(i==7){
      CLO8_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO8_Achievment_Report_$i', CLO8_Achievment_Report_controller);
    }
    if(i==8){
      CLO9_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO9_Achievment_Report_$i', CLO9_Achievment_Report_controller);
    }
    if(i==9){
      CLO10_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO10_Achievment_Report_$i', CLO10_Achievment_Report_controller);
    }
    if(i==10){
      CLO_Total_Achievment_Report_controller= await GSheetHelper().getColumn("ClO Achievment Report",i);
      GetStorageHelper.writeData('CLO_Total_Achievment_Report_$i', CLO_Total_Achievment_Report_controller);
    }
...
initCLOData()async{
  ...
  await getCLODataColumnFromExcel();
