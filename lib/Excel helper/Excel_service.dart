...
class ExcelHelper {
  ...
  static Future<String> readCell(String sheetName, String cell) async {
    final cellReference = cell;
    final column = cellReference.substring(0, 1).toUpperCase().codeUnitAt(0) - 65;
    final row = int.parse(cellReference.substring(1)) - 1;
    return await GSheetHelper().getCellData(sheetName, row+1, column+1);
  }
...
convertToCellRowandColunm(cellindex){
